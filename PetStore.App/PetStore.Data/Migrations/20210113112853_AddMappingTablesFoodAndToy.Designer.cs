...
namespace PetStore.Data.Migrations
{
    ...
    [Migration("20210113112853_AddMappingTablesFoodAndToy")]
    partial class AddMappingTablesFoodAndToy
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetStore.Models.Foods.Food", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PetStore.Models.FoodOrder", b =>
                {
                    b.HasOne("PetStore.Models.Foods.Food", "Food")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("PetStore.Models.Order", b =>
                {
                    b.HasOne("PetStore.Models.Toy", null)
                        .WithMany("Orders")
                        .HasForeignKey("ToyId");
